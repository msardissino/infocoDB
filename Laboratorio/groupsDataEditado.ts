...
export const GROUPS_DATA: GroupDetail[] = [
  {
    ...
    interview: {
      qaList: [
        { question: "@Cómo es tu nombre completo?", answer: "Agustín Pis Perez." }, // Wait, did the user change ¿ to @ or something? No, it's ¿Cómo es tu nombre completo? Let's check.
  ...
  },
  {
    ...
    members: [
      ...
      { name: "Andres", icon: "coffee", details: ["Estar con amigos", "Pasear al perro", "Gimnasio", "Teatro", "Pastas", "Pizza"], avatarUrl: "/images/group/quienes_somos/Andrés.jpg" },
